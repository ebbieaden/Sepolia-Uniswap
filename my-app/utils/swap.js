...
export const getAmountOfTokensReceivedFromSwap = async (
    ...
    if (ethSelected) {
        ...
        // '_swapAmoutWei' the input reserce would be the 'Crypto Dev' token reserve of the contract and output reserve
...
export const swapTokens = async (
    ...
    let tx;
    // If Eth is selecets call the 'ethCryptoDevToken' function else
    ...
    if (ethSelected) {
        tx = await exchangeContract.ethCryptoDevToken(
            tokenToBeReceivedAfterSwap,
            {
                value: swapAmountWei,
            }
        ...
        // User has to approve 'swapAmountWei' for the contract because 'CryptoDev' token
        // is an ERC20
